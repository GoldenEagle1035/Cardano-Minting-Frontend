      ...
      <div className="mx-auto bg-black border-t-2 border-white">
        <footer className="py-12 xl:py-12">
          <div className="px-4 mx-auto w-full max-w-8xl">
              ...
              <div>
                ...
                <ul>
                  <li className="mb-4">
                    <a
                      href="#"
                      className="font-normal text-gray-200 hover:text-white hover:underline"
                    >
                      Marketing
                    </a>
                  </li>
            ...
            <span className="block text-center text-gray-200 hover:text-white font-">
              © <span id="currentYear">2023</span>{" "}
              <a href="#">Cardano Minting,</a> LLC.All Rights
              Reserved.
            </span>
          </div>
        </footer>
